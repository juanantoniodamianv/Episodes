...
class FunctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post functions_url, params: { function: { date_entry: @function.date_entry, name: @function.name, status: @function.status } }
    end
  ...
  test "should update function" do
    patch function_url(@function), params: { function: { date_entry: @function.date_entry, name: @function.name, status: @function.status } }
